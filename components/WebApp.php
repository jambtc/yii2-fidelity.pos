...
class WebApp extends Component
{
    ...
    public static function showInvoiceRow($data){
        $dateLN = date("d M `y",$data->invoice_timestamp);
        $timeLN = date("H:i:s",$data->invoice_timestamp);

        $price = $data->price;
        $color = 'green';
        $addressToShow = WebApp::encrypt($data->id);
        ...
        $line = '
        <a href="index.php?r=invoices/view&id='. self::encrypt($data->id) . '" />
        <div class="container-fluid m-0 p-0">
              <div class="row">
                  <div class="col-12 m-0 p-0">
                      <div class="card shadow">
